    ...
    ?>
        <FORM action="Modi.php" method="POST" name="FormModi">
            ...
            <tr>
                ...
                <td width="243"> <input type="TEXT" name="pais" size="20" maxlength="50"
            ...
            <tr>
                ...
                <td width="243"> <input type="NUMBER" name="superficie" size="20" 
                value="<?php echo($fila['superficie']); ?>">
                </td>
            </tr>
            <tr>
                <td> Posee metro: </td>
                <td> <input type="checkbox" name="tieneMetro" value="<?php echo($fila['tieneMetro']); ?>"> </td>
            </tr>
            <tr>
